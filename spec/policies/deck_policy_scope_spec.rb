...
RSpec.describe DeckPolicy::Scope do
  ...
  context 'a users decks' do
    subject { described_class.new(user, User.find_by(:first_name => 'user1').decks).resolve }
    ...
    context 'for a guest' do
      ...
      it 'should show all public decks' do
        expect(subject.pluck :name).to match_array %w[u1d1]
      end
    end
    ...
    context 'for user 1' do
      ...
      it 'should show public, protected, owned and collaborated decks' do
        expect(subject.pluck :name).to match_array %w[u1d1 u1d2 u1d3 u1d4]
      end
    end
    ...
    context 'for user 2' do
      ...
      it 'should show public, protected and collaborated decks' do
        expect(subject.pluck :name).to match_array %w[u1d1 u1d2 u1d4]
      end
    end
    ...
    context 'for user 4' do
      ...
      it 'should show public, protected and collaborated decks' do
        expect(subject.pluck :name).to match_array %w[u1d1 u1d2]
      end
    end
  end
end
