...
RSpec.describe NotificationPolicy::Scope do
  ...
  before :each do
    ...
    create :notification, :deck => d1, :subject => d1.owner
    create :notification, :deck => d2, :subject => d2.owner
    create :notification, :deck => d3, :subject => d3.owner
    create :notification, :deck => d4, :subject => d4.owner
    create :notification, :deck => d5, :subject => d5.owner
  end
