...
import SlideDebugView
  from 'presentationals/components/slide-editor/SlideDebugView';
import { getActiveSlideId } from 'selectors/app/slide-editor';
import { getSlideById } from 'selectors/entities/slides';
import {
  getNestedContentItemObjectById,
...
function mapStateToProps(state) {
  ...
  if (
    activeSlide &&
    activeSlide.contentItemIds instanceof Array &&
    activeSlide.contentItemIds.length > 0
  ) {
