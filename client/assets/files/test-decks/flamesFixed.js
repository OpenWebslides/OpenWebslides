  ...
  <body class="shower list">
    ...
    <section class="slide" id="TrumpTweet">
      ...
      <blockquote class="twitter-tweet" data-lang="en">
        <p lang="en" dir="ltr">The two fake news polls released yesterday, ABC &amp; NBC, while containing some very positive info, were totally wrong in General E. Watch!</p>&mdash; Donald J. Trump (@realDonaldTrump) <a
              href="https://twitter.com/realDonaldTrump/status/856481786938916865">April 24, 2017</a>
      </blockquote>
    </section>
    ...
    <div class="slide" id="webslides">
          ...
          <svg version="1.1"
            ...
            <text transform="translate(339 81)"
                  style="font: 40px Arial; font-weight: bold; font-style: italic; letter-spacing: 1px;">webslides</text>
            ...
            <g class="next">
              ...
              <g id="mouse">
                <polygon style="fill: white; stroke: black"
                         stroke-width="2"
                         points="343.75,223.53 347.69,245.22 354.69,239.13 368.79,255.94 373,252.28 358.6,235.73 365.21,229.97 		" />
          ...
          <svg version="1.1"
            ...
            <g class="next">
              <g>
                <path fill="none"
                      ...
                      stroke-width="4"
                      stroke-miterlimit="10"
                      d="M179.07,236.84c20.97-37.32,73.58-84.39,97.96-99.23" />
                <polygon fill="#1E64C8"
                         points="263.82,161.75 260.72,159.22 277.29,138.92 251.55,143.82 250.8,139.89 287.33,132.94 				" />
              </g>
            ...
            <g class="next" id="acceptatie">
              <g>
                ...
                <polygon fill="#1E64C8"
                         points="526.18,207.17 529.54,204.99 543.84,226.95 547,200.94 550.96,201.42 546.48,238.34 				" />
              </g>
            ...
            <g class="next" id="update">
              <g>
                <path fill="none"
                      ...
                      stroke-width="4"
                      stroke-miterlimit="10"
                      d="M593,328.18c16.86-5.35,41.35-15.77,73.25-58.63" />
                <polygon fill="#1E64C8"
                         points="661.74,295.86 657.92,294.66 665.74,269.66 643.68,283.79 641.52,280.42 672.84,260.36 				" />
              </g>
    ...
    <section class="slide" id="mindset">
      ...
      <img src="http://madra.com/wp-content/uploads/2015/10/online-marketing-tools.jpg"
               alt="[tools picture]"
               width="800"
               height="400">
    </section>
    ...
    <section class="slide" id="mentimeter-interest">
      <iframe src="https://www.mentimeter.com/s/dd4ec8b136ec6826c7b666dd08d1de2a/820fdf2743b8"
                  height="500"
                  width="820"></iframe>
    ...
    <section class="slide" id="open-technologyFB">
      ...
      <ul>
            <li><strong>closed</strong> Facebook groups or university  <strong>log-in walls</strong></li>
          </ul>
    ...
    <section class="slide" id="open-exampleRuben">
      ...
      <blockquote class="twitter-tweet" data-lang="en">
        <p lang="en"
                 dir="ltr">Last part of Web Fundamentals, Linked Data Publishing, now available as <a href="https://twitter.com/OpenWebSlides">@OpenWebSlides</a>: <a
                  href="https://t.co/Lh0JMdSBtg">https://t.co/Lh0JMdSBtg</a> <a href="https://twitter.com/hashtag/LinkedData?src=hash">#LinkedData</a> <a
                  href="https://twitter.com/hashtag/SemWeb?src=hash">#SemWeb</a> <a href="https://twitter.com/hashtag/ITech16?src=hash">#ITech16</a></p>&mdash; Ruben Verborgh (@RubenVerborgh) <a
              href="https://twitter.com/RubenVerborgh/status/710429385250250754">March 17, 2016</a>
      </blockquote>
    </section>
    ...
    <section class="slide" id="open-audience-exampleRuben2">
      <h2>Example: <a href="https://ruben.verborgh.org/">Ruben</a>'s course</h2>
      <blockquote class="twitter-tweet" data-lang="en"><p lang="en" dir="ltr">Students keep on correcting my slides—and I like it :-) <a
              href="https://t.co/JVtuN6br42">https://t.co/JVtuN6br42</a> All of that is possible with <a href="https://twitter.com/OpenWebSlides">@OpenWebSlides</a>! <a
              href="https://twitter.com/hashtag/Innoversity?src=hash">#Innoversity</a></p>&mdash; Ruben Verborgh (@RubenVerborgh) <a
              href="https://twitter.com/RubenVerborgh/status/700407350159663108">February 18, 2016</a></blockquote>
    </section>
    ...
    <section class="slide" id="influence">
      ...
      <img src="http://www.tubefilter.com/wp-content/uploads/2015/06/Pixability-Beauty-on-YouTube-2015-Infographic.jpg"
               alt="[influence picture]"
               width="700"
               height="450">
    </section>
    ...
    <div class="white slide" id="creators-tweetout">
      <figure>
        <img src="https://www.screenflanders.be/uploads/images/location/9169/leuven_arenbergkasteel_2__normal.jpg"
                   alt=""
                   class="cover"
                   height="400">
      ...
      <p>
        <a href="https://twitter.com/intent/tweet?button_hashtag=FLAMES"
                 class="twitter-hashtag-button"
                 data-url="https://openwebslides.github.io/presentatie_FLAMES/"
                 data-dnt="true">Tweet #FLAMES</a>
      </p>
    </div>
  
    <section class="slide" id="mentimeter-feedback">
      <iframe src="https://www.mentimeter.com/s/dd4ec8b136ec6826c7b666dd08d1de2a/c8f94812cff0"
                  height="500"
                  width="820"></iframe>
      <p class="center">Go to <a href="https://www.menti.com/6f7d25">www.menti.com</a> (code 30 73 6)</p>
    </section>
