...
describe('parseSlideString', () => {
  ...
  it('returns an empty deck when no slides are present', () => {
    const slides = '';
    ...
    expect(parseDeck(deckString)).toEqual({
      ...
      contentBlocks: {
        byId: {
          ...
          4: { id: 4, type: contentBlockTypes['#text'], value: 'tears in the' },
          5: { id: 5, type: contentBlockTypes.STRONG, childIds: [6] },
  ...
  it('can parse multiple slides with 1 content block', () => {
    const slides =
  ...
  it('can parse multiple slides with multiple nested content blocks', () => {
    const slides =
  ...
  it('can save the html classes of content blocks', () => {
    const slides =
  ...
  it('can parse data attributes of content blocks', () => {
    const slides =
  ...
  it('can save long data attribute names with dashes in camelCase', () => {
    const slides =
  ...
  it('can save the html id of content blocks', () => {
    const slides =
